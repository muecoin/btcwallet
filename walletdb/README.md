...
[![GoDoc](https://godoc.org/github.com/muecoin/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/muecoin/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/muecoin/btcwallet/walletdb

## Installation

```bash
$ go get github.com/muecoin/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/muecoin/btcwallet/walletdb#example-package--BasicUsage)  
